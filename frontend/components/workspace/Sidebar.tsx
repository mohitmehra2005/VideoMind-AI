      ...
      >
        ...
        <div className="flex flex-col flex-1 overflow-hidden">
          ...
          <div className="h-16 px-3.5 flex items-center justify-between border-b border-white/[0.06]">
            {isSidebarExpanded ? (
              ...
              <button
                ...
                className="w-full flex items-center justify-center p-1 rounded-xl text-slate-400 hover:text-white transition-all group"
              >
          ...
          <div className="p-3 space-y-2.5">
            ...
            <button
              ...
              className={`w-full flex items-center justify-center gap-2 rounded-xl transition-all font-semibold text-xs ${
                isSidebarExpanded
                    ...
                    {filteredHistory.length > 0 ? (
                      filteredHistory.map((item) => (
                        <button
                          ...
                          className={`w-full text-left p-2.5 rounded-xl text-xs truncate transition-all flex items-center gap-2.5 ${
                ...
                <div className="space-y-3">
                  <div className="p-3.5 rounded-2xl bg-indigo-950/30 border border-indigo-500/20 text-xs space-y-2.5">
                    ...
                    <button
                      ...
                      className="w-full py-2 px-3 rounded-xl bg-gradient-to-r from-indigo-500/30 to-cyan-500/20 hover:from-indigo-500/40 hover:to-cyan-500/30 border border-indigo-500/30 text-white text-xs font-semibold transition-all shadow-sm"
                    >
        ...
        <div className="p-3 border-t border-white/[0.06] relative">
          ...
          <button
            ...
            className={`w-full flex items-center gap-2.5 p-2 rounded-xl hover:bg-white/[0.05] transition-colors ${
          ...
          {showAccountMenu && (
            <div className="absolute bottom-16 left-3 right-3 p-4 rounded-2xl bg-[#0c101a] border border-white/10 shadow-2xl shadow-black/90 space-y-3.5 z-50 animate-in fade-in slide-in-from-bottom-2">
              
              {user.isGuest ? (
                <div className="space-y-3">
                  <div className="text-xs text-slate-300">
                    <p className="font-semibold text-white mb-0.5">Browsing as Guest</p>
                    <p className="text-[11px] text-slate-400">Sign in with Google to save analysis history permanently.</p>
                  </div>
                  
                  <button
                    onClick={handleGoogleSignIn}
                    className="w-full py-2.5 px-3 bg-white hover:bg-slate-100 text-slate-900 font-semibold text-xs rounded-xl flex items-center justify-center gap-2 transition-all shadow-md"
                  >
                ...
                <div className="space-y-3">
                  <div className="text-xs text-slate-300 pb-2 border-b border-white/5">
                  ...
                  <button
                    ...
                    className="w-full py-2 px-2.5 text-left text-xs text-red-400 hover:bg-red-500/10 rounded-lg flex items-center gap-2 transition-colors"
                  >
